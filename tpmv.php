...
<nav role="navigation" aria-label="NAV">
        <div class="ibm-sitenav-menu-container">
            <div class="ibm-sitenav-menu-name">
                <div id="ibm-home"><a>IBM®</a></div>
                <a href="visitor.php">&nbsp;&nbsp;&nbsp;&nbsp;CTRLSYSTEM</a></div>
        
          <div class="ibm-sitenav-menu-list">
                <ul role="menubar">
                    <li role="presentation"><a role="menuitem" href="visitor.php">Ctrl of Assets</a></li>
                    <li role="presentation" class="ibm-highlight"><a role="menuitem"  href="tpmv.php">TPM</a></li>
        ...
        array_push($names, $row[0]);
            ...
            $response2 =db2_prepare($db2, $query2);
             ...
             while($row2 = db2_fetch_array($response2)){
                ...
                if($flag==1){
                    echo ' <tr bgcolor="#FFFF00"><form action="tpmvdetails.php" method="post"><td align="center">'.$row[0].'</td>
                        ...
                        <td align="center" class="ibm-ind-link"><input type="hidden" name="area" value="'.$row[0].'"><button type="submit" class="ibm-btn-sec ibm-btn-transparent" ibm-btn-small"><a href="#" class="ibm-view-link"></a></button></td>
                         ...
                         echo ' <tr><form action="tpmvdetails.php" method="post"><td align="center">'.$row[0].'</td>
                        <td align="center">'.$percent.'%</td>
                        <td align="center" class="ibm-ind-link"><input type="hidden" name="area" value="'.$row[0].'"><button type="submit" class="ibm-btn-sec ibm-btn-transparent" ibm-btn-small"><a href="#" class="ibm-view-link"></a></button></td>
                   </form></tr> ';
                } 
