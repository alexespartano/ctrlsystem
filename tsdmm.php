          ...
          $stmt = db2_prepare($db2, $query);
               ...
               while($row = db2_fetch_array($stmt)){
                ...
                if($anomantto < $anotoday){
                  //expirado
                  echo '<tr bgcolor="#ff5050"><form action="tsdmmw.php" method="post" class="ibm-row-form"><td align="center" >' .
            $row[0] . '</td><td align="center">' .
            $row[1] . '</td><td align="center">' .
            $row[2] . '</td><td align="center">' .
            $row[3] . '</td>
            <td><input type="text" name="enc" size="5"></td>
            <td><input type="text" name="uno" size="5"></td>
            <td><input type="text" name="dos" size="5"></td>
            <td><input type="text" name="tres" size="5"></td>
            ...
            $row[4] . '</td><td align="center" class="ibm-ind-link"><input type="hidden" name="identification" value="'.$row[5].'"> <button type="submit" id="subutton" class="ibm-btn-sec ibm-btn-transparent " ibm-btn-small "><a href="#" class="ibm-confirm-link"></a></button></td></form> ';
                  ...
                  if($anomantto == $anotoday){
                    ...
                    if($mestoday == $mesmantto){
                      //about to expire
                      echo '<tr bgcolor="#efc100"><form action="tsdmmw.php" method="post" class="ibm-row-form"><td align="center" >' .
                      $row[0] . '</td><td align="center">' .
                         $row[1] . '</td><td align="center">' .
                         $row[2] . '</td><td align="center">' .
                         $row[3] . '</td>
