...
<div class="ibm-columns ibm-center" data-widget="setsameheight" data-items=".ibm-blocklink">
    ...
    <table class="ibm-data-table ibm-center ibm-center-block" id="myTable">
            ...
            $query = 'SELECT  "AREA","BRAND","TYPE","SN","MATTO", "ID" FROM CTRLSYSTEM.TINV WHERE "ING"='."'$use'".' AND "ACCION"='."'CALIBRACION EXTERNA'";
          $stmt = db2_prepare($db2, $query);
               ...
               while($row = db2_fetch_array($stmt)){
                ...
                $datemantto=DateTime::createFromFormat('d/m/y', $fech);
                  ...
                  $difer=date_diff($fechatoday,$datemantto);
                    ...
                    if($sim == "+" && $numb < 41){
                      //about to expired
                      echo '<tr bgcolor="#efc100"><form action="temmw.php" method="post" class="ibm-row-form"><td align="center" >' .
            ...
            $row[4] . '</td><td align="center" class="ibm-ind-link"><input type="hidden" name="identification" value="'.$row[5].'"> <button type="submit" id="subutton" class="ibm-btn-sec ibm-btn-transparent " ibm-btn-small "><a href="#" class="ibm-confirm-link"></a></button></td></form> ';
                   ...
                   if($sim == "-"){
                      //exiperd
                 echo '<tr bgcolor="#ff5050"><form action="temmw.php" method="post" class="ibm-row-form"><td align="center" >' .
            $row[0] . '</td><td align="center">' .
            $row[1] . '</td><td align="center">' .
            $row[2] . '</td><td align="center">' .
            $row[3] . '</td><td align="center">' .
