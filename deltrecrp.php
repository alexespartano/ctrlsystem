  ...
  <body id="ibm-com" class="ibm-type">
    <div id="ibm-top" class="ibm-landing-page">
        ...
        <div class="ibm-columns ibm-seamless ibm-padding-bottom-0 ibm-pull-quote ibm-h1">
            <div class="ibm-col-6-6" id="1">
               <p class=" ibm-h1 ibm-center">ARE YOU SURE THAT WANT TO DELETE THE  RECORD OF PREVENTIVE CHECKOUT TABLE? (YOU MUST TO BACKUP THE INFO. BEFORE YOU DELETE )</p>
                </div>
        </div>
    ...
    <?php 
            if(isset($_POST['submit'])){
              ...
              $tru = "TRUNCATE CTRLSYSTEM.TRECRP IMMEDIATE";
