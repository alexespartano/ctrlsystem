        ...
        <div class="collapse navbar-collapse" id="a">
            <ul class="nav navbar-nav">
                <li><a href="main.php">HOME</a></li>
                 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li id="highlightbox"><a href="perdel.php">DELETE</a></li>
                    </ul>
                </li>
                ...
                <li><a href="TPMVIEWER.php">TPM</a></li>
                 <li><a href="spareparts.php">SPARE PARTS</a></li>            </ul>
...
<form action="#">
    <div class="row" id="FILTERSBOX">
        ...
        <div class="col-sm-2">
            ...
            <br>
            <br>
             <select id="Input5" placeholder="STATUS" title="SEARCH FOR STATUS AS=ASIGNADO, AL=ALMACEN" style="font-size: 9px;">
        ...
        <div class="col-sm-2">
        <select  id="Input7" placeholder="RESPONSIBLE" title="SEARCH FOR RESPONSIBLE" style="font-size: 9px;">
        ...
        <select  id="Input8" placeholder="ING" title="SEARCH FOR ING RESPONSIBLE" style="font-size: 9px;">
            ...
            <option value="ING1">ING2</option>
            <option value="ING1">ING3</option>
...
<div class="row" id="tablecontainer">
	<div class="col-sm-12">
        ...
        while($row = db2_fetch_array($stmt)){
            echo '<tr><td align="center"><a href="#" onclick="javascript:modi('.$row[18].');"><i class="glyphicon glyphicon-trash" style="font-size:1.5em;"></i></a></td><td align="center">' .
