...
<script src="//1.www.s81c.com/common/v18/js/forms.js"></script>
    ...
    <script script type="text/javascript" src="js/filterstool.js"></script>
...
<select  id="Input4" title="SEARCH FOR BRAND">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;
<select id="Input5" title="SEARCH FOR ING RESPONSIBLE">
...
<div class="ibm-col-6-2  ibm-nospacing">
    <span class="ibm-ind-link ibm-btn-row"><a class="ibm-refresh-link ibm-btn-sec ibm-btn-blue-50" href="#" onClick="window.location.reload()">Refresh</a><a class="ibm-search-link ibm-btn-sec ibm-btn-blue-50" href="#" onclick="filtertool()">Search</a><a class="ibm-calculator-link ibm-btn-sec ibm-btn-blue-50">Items:<b id="con"></b></a><a class="ibm-add-link ibm-btn-sec ibm-btn-blue-50" href="#" onclick="javascript:add();">Add</a><a class="ibm-remove-link ibm-btn-sec ibm-btn-blue-50" href="#" onclick="javascript:del();">Remove</a></span>
</div>
</form>
</div>
<!--ENDFILTERS-->
...
<div class="ibm-columns ibm-seamless ibm-padding-bottom-0" data-widget="setsameheight" data-items=".ibm-blocklink">
    <div class="ibm-col-1-1 ibm-nospacing">
    <table class="ibm-data-table ibm-padding-small ibm-center" id="myTable" data-scrollaxis="x" cellspacing="0" cellpadding="0" border="0" style="font-size: 10px;">
            <thead>
                <tr>
                    <th>MODIFY</th>
                    <th>AREA</th>
            ...
            $query = 'SELECT "ID","AREA","BRAND","ACCION","TYPE","SN","MODEL","COMMENTS","TRADEMARK","NOM","MATTO","ING","FREC" FROM CTRLSYSTEM.TINV ORDER BY "BRAND"';
             $stmt = db2_prepare($db2, $query); 
            if($stmt){     
                        $result = db2_execute($stmt);
                        if (!$result) {
        ...
        while($row = db2_fetch_array($stmt)){
            echo '<tr><td align="center" class="ibm-ind-link"><a href="#" onclick="javascript:modi('.$row[0].');" class="ibm-edit-link"></a></td><td align="center">' .
...
<script>
function modi(id){
    win2 = window.open('tmod.php?id='+id,'Modifica_U','scrollbars=no,top=20,left=500,width=700,height=400');    
}
function add(){
 win3 = window.open('tadd.php','Modifica_U','scrollbars=no,top=20,left=300,width=900,height=500'); 
}
function del(){
 win3 = window.open('tdel.php','Modifica_U','scrollbars=no,top=220,left=500,width=700,height=450'); 
}
</script>
  </body>
    <br>
