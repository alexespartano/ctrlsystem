...
<nav role="navigation" aria-label="NAV">
        <div class="ibm-sitenav-menu-container">
            <div class="ibm-sitenav-menu-name">
                ...
                <ahref="visitor.php"> &nbsp;&nbsp;&nbsp;&nbsp;CTRLSYSTEM</a></div>

            <div class="ibm-sitenav-menu-list">
                <ul role="menubar">
                    <li   role="presentation" class="ibm-highlight"><a role="menuitem" href="visitor.php">Ctrl of Assets</a></li>
                    <li role="presentation"><a role="menuitem"  href="tpmv.php">TPM</a></li>
