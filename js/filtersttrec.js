...
function clear(oForm){ 
  ...
  for(i=0; i<elements.length; i++) {
	...
	if (td && td2) {
      if (td.innerHTML.toUpperCase().indexOf(fil1) > -1 && td2.innerHTML.toUpperCase().indexOf(fil2) > -1 && td3.innerHTML.toUpperCase().indexOf(fil3) > -1 && td4.innerHTML.toUpperCase().indexOf(fil4) > -1 && td5.innerHTML.toUpperCase().indexOf(fil5) > -1) {
        tr[i].style.display = "";
        count= count + 1;
      } else {
