...
<div class="ibm-columns ibm-seamless ibm-padding-bottom-0" data-widget="setsameheight" data-items=".ibm-blocklink">
    ...
    <div class="ibm-col-1-1">
      <p class="ibm-center  ibm-h1">Add MFG User</p>
    </div>
  </div>
   <form  action="adduserw.php" method="post" class="ibm-row-form">
      <div class="ibm-columns">
        <div class="ibm-col-12-3"></div>
       <div class="ibm-col-12-3 ibm-center">
      <label for="us">Username:<span class="ibm-required">*</span></label>
                    <input type="text" size="20" id="us" name="username">
    </div>
    <div class="ibm-col-12-3 ibm-center">
        <label for="pa">Password:<span class="ibm-required">*</span></label>
                    <input type="text" size="20" id="pa" name="pass">
    </div>
      </div>
      <div class="ibm-columns">
<div class="ibm-col-1-1">
  <p class="ibm-center"><button type="submit" class="ibm-ind-link ibm-btn-sec ibm-btn-transparent"><a class="ibm-confirm-link">Create</a></button></p>
</div>
</div>
</form>
